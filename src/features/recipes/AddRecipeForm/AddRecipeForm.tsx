  ...
  return (
    ...
    >
      {({
        ...
        const addIngredient = () => {
          if (!ingredientId) {
            notify.error('Select an ingredient.');
            return;
          }

          if (!measure.trim()) {
            notify.error('Enter ingredient quantity.');
            return;
          }
          ...
          if (!ingredient) {
            notify.error('Selected ingredient was not found.');
            return;
          }
          ...
          if (!ingredientDbId || ingredientDbId === 'undefined' || ingredientDbId === 'null') {
            notify.error('Selected ingredient has an invalid ID.');
            return;
          }
